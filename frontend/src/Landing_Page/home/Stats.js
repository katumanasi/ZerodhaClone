        ...
        <div className='row p-5'>
          <div className='col-6 p-5'>
            ...
            <p className='text-muted'>That's why 1.3+ crore customers trust Zerodha with 
              ₹3.5+ lakh crores worth of equity investments.</p>
          ...
          <div className='col-6 p-5'>
            ...
            <div>
              <a href="" className='mx-5 fs-5'  style={{textDecoration:"none"}}>Explore out products <i class="fa-solid fa-arrow-right" ></i></a>
             <a href ="" className='fs-5'  style={{textDecoration:"none"}}>Try Kite demo <i class="fa-solid fa-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </div>
